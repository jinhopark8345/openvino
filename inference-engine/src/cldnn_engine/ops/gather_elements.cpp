...
void CreateGatherElementsOp(Program& p, const std::shared_ptr<ngraph::op::v5::GatherElement>& op) {
    ...
    auto primitive = cldnn::gather_element(layerName,
                                           inputPrimitives[0],
                                           inputPrimitives[1],
                                           indices_rank,
                                           batch_dims);
...
REGISTER_FACTORY_IMPL(v5, GatherElement);
