...
#define CASE_GATHER_ND8_FP16_4D_1 data_types::f16, format::bfyx, {6, 7, 9, 8}, format::bfyx, {3, 1, 1, 1}, format::bfyx, {3, 7, 9, 8}, 6, 2, 0, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_4D_2 data_types::f16, format::bfyx, {6, 7, 9, 8}, format::bfyx, {6, 1, 1, 1}, format::bfyx, {6, 8, 1, 9}, 6, 2, 1, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_4D_3 data_types::f16, format::bfyx, {5, 4, 7, 2}, format::bfyx, {5, 4, 1, 2}, format::bfyx, {40, 1, 1, 1}, 6, 4, 3, data_types::f16, format::bfyx

#define CASE_GATHER_ND8_FP16_5D_1 data_types::f16, format::bfzyx, {5, 6, 7, 8, 5}, format::bfyx, {5, 1, 1, 1}, format::bfzyx, {5, 6, 7, 8, 5}, 5, 2, 0, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_5D_2 data_types::f16, format::bfzyx, {5, 6, 7, 8, 5}, format::bfyx, {5, 1, 1, 1}, format::bfyx, {5, 5, 7, 8}, 5, 2, 1, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_5D_3 data_types::f16, format::bfzyx, {5, 4, 7, 8, 5}, format::bfyx, {5, 4, 1, 3}, format::bfyx, {20, 1, 1, 1}, 4, 3, 2, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_5D_4 data_types::f16, format::bfzyx, {5, 4, 7, 8, 3}, format::bfyx, {5, 4, 1, 3}, format::bfyx, {60, 7, 1, 1}, 4, 4, 3, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_5D_5 data_types::f16, format::bfzyx, {5, 4, 7, 2, 3}, format::bfzyx, {5, 4, 1, 2, 3}, format::bfyx, {120, 1, 1, 1}, 4, 5, 4, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_5D_6 data_types::f16, format::bfzyx, {5, 4, 7, 4, 4}, format::bfzyx, {5, 4, 1, 1, 3}, format::bfzyx, {20, 3, 7, 4, 1}, 4, 5, 2, data_types::f16, format::bfyx

#define CASE_GATHER_ND8_FP16_6D_1 data_types::f16, format::bfwzyx, {5, 4, 6, 7, 8, 5}, format::bfyx, {5, 4, 2, 2}, format::bfyx, {20, 2, 6, 7}, 5, 4, 2, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_6D_2 data_types::f16, format::bfwzyx, {5, 4, 6, 7, 8, 2}, format::bfyx, {5, 4, 2, 2}, format::bfyx, {40, 6, 1, 1}, 5, 4, 3, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_6D_3 data_types::f16, format::bfwzyx, {5, 4, 6, 7, 2, 2}, format::bfzyx, {5, 4, 1, 2, 2}, format::bfyx, {80, 6, 1, 1}, 5, 5, 4, data_types::f16, format::bfyx
#define CASE_GATHER_ND8_FP16_6D_4 data_types::f16, format::bfwzyx, {5, 4, 6, 3, 2, 2}, format::bfwzyx, {5, 4, 1, 3, 2, 2}, format::bfyx, {240, 1, 1, 1}, 5, 6, 5, data_types::f16, format::bfyx

#define CASE_GATHER_ND8_FP32_4D_1 data_types::f32, format::bfyx, {6, 7, 9, 8}, format::bfyx, {3, 1, 1, 1}, format::bfyx, {3, 7, 9, 8}, 6, 2, 0, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_4D_2 data_types::f32, format::bfyx, {6, 7, 9, 8}, format::bfyx, {6, 1, 1, 1}, format::bfyx, {6, 8, 1, 9}, 6, 2, 1, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_4D_3 data_types::f32, format::bfyx, {5, 4, 7, 2}, format::bfyx, {5, 4, 1, 2}, format::bfyx, {40, 1, 1, 1}, 6, 4, 3, data_types::f32, format::bfyx

#define CASE_GATHER_ND8_FP32_5D_1 data_types::f32, format::bfzyx, {5, 6, 7, 8, 5}, format::bfyx, {5, 1, 1, 1}, format::bfzyx, {5, 6, 7, 8, 5}, 5, 2, 0, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_5D_2 data_types::f32, format::bfzyx, {5, 6, 7, 8, 5}, format::bfyx, {5, 1, 1, 1}, format::bfyx, {5, 5, 7, 8}, 5, 2, 1, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_5D_3 data_types::f32, format::bfzyx, {5, 4, 7, 8, 5}, format::bfyx, {5, 4, 1, 3}, format::bfyx, {20, 1, 1, 1}, 4, 3, 2, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_5D_4 data_types::f32, format::bfzyx, {5, 4, 7, 8, 3}, format::bfyx, {5, 4, 1, 3}, format::bfyx, {60, 7, 1, 1}, 4, 4, 3, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_5D_5 data_types::f32, format::bfzyx, {5, 4, 7, 2, 3}, format::bfzyx, {5, 4, 1, 2, 3}, format::bfyx, {120, 1, 1, 1}, 4, 5, 4, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_5D_6 data_types::f32, format::bfzyx, {5, 4, 7, 4, 4}, format::bfzyx, {5, 4, 1, 1, 3}, format::bfzyx, {20, 3, 7, 4, 1}, 4, 5, 2, data_types::f32, format::bfyx

#define CASE_GATHER_ND8_FP32_6D_1 data_types::f32, format::bfwzyx, {5, 4, 6, 7, 8, 5}, format::bfyx, {5, 4, 2, 2}, format::bfyx, {20, 2, 6, 7}, 5, 4, 2, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_6D_2 data_types::f32, format::bfwzyx, {5, 4, 6, 7, 8, 2}, format::bfyx, {5, 4, 2, 2}, format::bfyx, {40, 6, 1, 1}, 5, 4, 3, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_6D_3 data_types::f32, format::bfwzyx, {5, 4, 6, 7, 2, 2}, format::bfzyx, {5, 4, 1, 2, 2}, format::bfyx, {80, 6, 1, 1}, 5, 5, 4, data_types::f32, format::bfyx
#define CASE_GATHER_ND8_FP32_6D_4 data_types::f32, format::bfwzyx, {5, 4, 6, 3, 2, 2}, format::bfwzyx, {5, 4, 1, 3, 2, 2}, format::bfyx, {240, 1, 1, 1}, 5, 6, 5, data_types::f32, format::bfyx



class GatherND8PrimitiveFusingTest : public ::BaseFusingTest<gather_nd8_test_params> {
public:
    void execute(gather_nd8_test_params& p) {
        auto input_prim = get_mem(get_input_layout(p));
        network network_not_fused(this->engine, this->topology_non_fused, bo_not_fused);
        network network_fused(this->engine, this->topology_fused, bo_fused);
        network_fused.set_input_data("input", input_prim);
    ...
    layout get_input_layout(gather_nd8_test_params& p) {
        return layout{ p.data_type, p.input_format, p.input_shape };
    }

    layout get_indices_layout(gather_nd8_test_params& p) {
        return layout{ p.data_type, p.indices_format, p.indices_shape };
    }

    layout get_output_layout(gather_nd8_test_params& p) {
        return layout{ p.data_type, p.output_format, p.output_shape };
    }

    layout get_per_channel_layout(gather_nd8_test_params& p) {
        return layout{ p.default_type, p.default_format, tensor{1, p.output_shape.feature[0], 1, 1} };
    }
};

class gather_nd8_quantize : public GatherND8PrimitiveFusingTest {};
TEST_P(gather_nd8_quantize, basic) {
    auto p = GetParam();
    create_topologies(input_layout("input", get_input_layout(p)),
        data("gather_nd8_indices", get_mem(get_indices_layout(p), 0, p.max_number_in_indices - 1)),
        data("in_lo", get_mem(get_per_channel_layout(p), min_random, 0)),
        data("in_hi", get_mem(get_per_channel_layout(p), 1, max_random)),
        data("out_lo", get_mem(get_single_element_layout(p), -127)),
        data("out_hi", get_mem(get_single_element_layout(p), 127)),
        gather_nd8("gather_nd8_prim", "input", "gather_nd8_indices", p.indices_rank, p.batch_dims),
        quantize("quantize", "gather_nd8_prim", "in_lo", "in_hi", "out_lo", "out_hi", 255, data_types::i8),
        reorder("reorder_bfyx", "quantize", p.default_format, data_types::f32)
    );
    tolerance = 1.f;
    execute(p);
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu, gather_nd8_quantize,
    ::testing::ValuesIn(std::vector<gather_nd8_test_params>{
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_4D_1, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_4D_2, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_4D_3, 2, 3 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_1, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_2, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_3, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_4, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_5, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_6, 2, 3 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_6D_1, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_6D_2, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_6D_3, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_6D_4, 2, 3 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_4D_1, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_4D_2, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_4D_3, 2, 3 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_1, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_2, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_3, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_4, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_5, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_6, 2, 3 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_6D_1, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_6D_2, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_6D_3, 2, 3 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_6D_4, 2, 3 },
}));

class gather_nd8_activation_scale_eltwise : public GatherND8PrimitiveFusingTest {};
TEST_P(gather_nd8_activation_scale_eltwise, basic) {
    auto p = GetParam();
    ...
    create_topologies(input_layout("input", get_input_layout(p)),
        ...
        data("eltwise_data", get_mem(get_output_layout(p))),
        gather_nd8("gather_nd8_prim", "input", "gather_nd8_indices", p.indices_rank, p.batch_dims),
        activation("activation", "gather_nd8_prim", activation_func::abs),
        scale("scale", "activation", "scale_data"),
        eltwise("eltwise", { "scale", "eltwise_data" }, eltwise_mode::sum, p.data_type),
        reorder("reorder_bfyx", "eltwise", p.default_format, data_types::f32)
    );
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu, gather_nd8_activation_scale_eltwise,
    ::testing::ValuesIn(std::vector<gather_nd8_test_params>{
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_4D_1, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_4D_2, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_4D_3, 2, 5 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_1, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_2, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_3, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_4, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_5, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_5D_6, 2, 5 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_6D_1, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_6D_2, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_6D_3, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP16_6D_4, 2, 5 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_4D_1, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_4D_2, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_4D_3, 2, 5 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_1, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_2, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_3, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_4, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_5, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_5D_6, 2, 5 },

        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_6D_1, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_6D_2, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_6D_3, 2, 5 },
        gather_nd8_test_params{ CASE_GATHER_ND8_FP32_6D_4, 2, 5 },
}));
