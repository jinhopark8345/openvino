...
inline void DoTest(engine& engine,
    ...
    topology.add(
        gather_nd8("gather_nd8", "InputData", "InputIndices", indices_rank, batch_dims)
    );
    ...
    auto output = outputs.at("gather_nd8").get_memory();
...
TEST(gather_nd8_gpu_fp16, d23322_i231312_ir6_batch2) {
...
// TEST(gather_nd8_gpu_fp16, d231322_i231321_ir6_batch5) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d23322_i23321_ir5_batch4) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d23223_i2321_ir4_batch3) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d2342_i2312_ir4_batch2) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d234_i2311_ir4_batch2) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d234_i21_ir2_batch1) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d22_i21_ir2_batch1) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d3223_i321113_ir6_batch0) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d3221_i32312_ir3_batch0) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d3231_i32312_ir3_batch0) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d3112_i3221_ir4_batch0) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d311211_i322111_ir4_batch0) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d3332_i3223_ir4_batch0) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d3323_i322_ir3_batch0) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d22_i21_ir2_batch0) {
//     auto& engine = get_test_engine();
...
// TEST(gather_nd8_gpu_fp16, d22_i32_ir2_batch0) {
//     auto& engine = get_test_engine();
